...
public class GripPipeline extends OpenCvPipeline {
    ...
    public void process(Mat source0) {
        ...
        double blurRadius = 5.8558558558558556;
        blur(blurInput, blurType, blurRadius, blurOutput);

        // Step CV_cvtColor0:
        Mat cvCvtcolorSrc = blurOutput;
        int cvCvtcolorCode = Imgproc.COLOR_HSV2RGB;
        cvCvtcolor(cvCvtcolorSrc, cvCvtcolorCode, cvCvtcolorOutput);

        // Step HSV_Threshold0:
        Mat hsvThresholdInput = cvCvtcolorOutput;
        double[] hsvThresholdHue = {24.576271186440678, 74.70761621434175};
        double[] hsvThresholdSaturation = {126.13705645652969, 208.4090909090909};
        double[] hsvThresholdValue = {145.26836158192089, 215.22727272727272};
        ...
        double filterContoursMinArea = 777.0;
